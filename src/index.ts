...
if (!process.env.AZURE_DEVOPS_ORG_NAME) {
  throw new Error("Environment variable AZURE_DEVOPS_ORG_NAME is not set. Please set it to your Azure DevOps organization name.");
}

// export const orgName = argv.organization as string;
// const tenantId = argv.tenant;

export const orgName = process.env.AZURE_DEVOPS_ORG_NAME;
